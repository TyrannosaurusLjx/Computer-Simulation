...
```
    ...
    /var/folders/2z/kvvrz9fx7575sz8vyx1php7c0000gn/T/ipykernel_53910/2686341211.py:17: DeprecationWarning: Conversion of an array with ndim > 0 to a scalar is deprecated, and will error in future. Ensure you extract a single element from your array before performing this operation. (Deprecated NumPy 1.25.)
      return float(delta_S)
...
```python
# Jacobi实现
def Jacobi(A, b, X0=[[0],[0],[0]], k=1000):
    A = np.array(A)
